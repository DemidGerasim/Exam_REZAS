...
//QString cryptoController::encryptCard(QString card) {
//    EVP_CIPHER_CTX *ctx;
...
//    QString key = this->pin + ((QString)"0").repeated(32 - this->pin.length());
...
//    return ciphertext_qbyte.toBase64();//переводим в формат Base64 и записываем в файл
...
//QString cryptoController::decryptCard(QString text) {
//    EVP_CIPHER_CTX *ctx;
//    if(!(ctx = EVP_CIPHER_CTX_new())){ //EVP_CIPHER_CTX_new() creates a cipher context.
//        return "";
//    }
